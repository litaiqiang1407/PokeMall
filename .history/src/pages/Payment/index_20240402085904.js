            ...
            <Form.Group className={cx("form-field")}>
              <div className={cx("address-input__container")}>
                ...
                {showAddressSelection && (
                  ...
                  >
                    <Nav variant="underline" className={cx("address-header")}>
                      <Nav.Item className={cx("header-item")}>
                        <Nav.Link>Province/City</Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link>District</Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link> Ward/Commune</Nav.Link>
                      </Nav.Item>
                    </Nav>
                  </div>
                )}
