      ...
      <Container>
        ...
        <Container className={cx("payment-methods")}>
          <Container className={cx("payment-method")}>
            <span className={cx("method-title")}>Payment Method</span>
            <Container className={cx("method-content")}>
              <button className={cx("btn-payment")}>Cash on Delivery</button>
              <button className={cx("btn-payment")}>Credit Card</button>
            </Container>
          </Container>
        </Container>
      </Container>
