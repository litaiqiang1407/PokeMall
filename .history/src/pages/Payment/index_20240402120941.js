...
import { districtURL, provinceURL, wardURL } from "~/data";
...
function Payment() {
  ...
  const handleGetDistrict = (provinceID) => {
  ...
  const handleGetWard = (districtID) => {
    setActiveTab("ward");
    interactThirdParty(
  ...
  const handleGetAddress = (addressUnit, id) => {
    ...
    if (addressUnit === "district") {
      apiUrl = `${apiUrlDistrict}?province_id=${id}`;
    }
    if (addressUnit === "ward") {
      apiUrl = `${apiUrlWard}?district_id=${id}`;
    }
    interactThirdParty(
      apiUrl,
      "GET",
                          ...
                          <ul className={cx("address-list")}>
                            {listProvince.map((province, index) => (
                              <li
                                ...
                                onClick={() =>
                                  handleGetDistrict(province.ProvinceID)
                                }
                              >
                          ...
                          <ul className={cx("address-list")}>
                            {listDistrict.map((district, index) => (
                              <li
                                ...
                                className={cx("address-item")}
                                onClick={() =>
                                  handleGetWard(district.DistrictID)
                                }
                              >
