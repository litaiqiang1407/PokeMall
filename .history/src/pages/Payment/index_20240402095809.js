...
import { interactData, interactThirdParty } from "~/functions/interactData";
...
function Payment() {
  ...
  const handleGetAddress = (addressUnit) => {
                      ...
                      {activeTab === "province" && (
                        <div className={cx("province")}>
                          <ul className={cx("address-list")}>
                            <li className={cx("address-item")}>AAA</li>
                            <li className={cx("address-item")}>BBB</li>
                            <li className={cx("address-item")}>CCC</li>
                            <li className={cx("address-item")}>AAA</li>
                            <li className={cx("address-item")}>BBB</li>
                            <li className={cx("address-item")}>CCC</li>
                            <li className={cx("address-item")}>AAA</li>
