...
function MyAccount() {
  ...
  const handleClearInput = (name) => {
    setNewUserData({ ...newUserData, [name]: "" });
  };
    ...
    const updateData = {
      ...
      username:
        newUserData.username !== userData.username
          ...
          : undefined,
      name: newUserData.name !== userData.name ? newUserData.name : undefined,
      email:
        newUserData.email !== userData.email ? newUserData.email : undefined,
      phone:
        newUserData.phone !== userData.phone ? newUserData.phone : undefined,
      avatar:
        newUserData.avatar !== userData.avatar ? newUserData.avatar : undefined,
    };

    if (isValid) {
      const endpointURL =
        "http://localhost/pokemall/actions/changeAccountInfo.php";
      interactData(endpointURL, "POST", updateData, (response) => {
