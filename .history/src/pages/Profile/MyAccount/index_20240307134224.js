...
function MyAccount() {
  ...
  const [userData, setUserData] = useState({
    ...
    phone: "123-456-7890",
    avatar:
      "https://img.freepik.com/premium-vector/cute-avocado-cartoon-hand-drawn-style_42349-476.jpg",
  });
            ...
            <Container className={cx("profile-photo")}>
              <Container className={cx("photo-info")}>
                ...
                <Container className={cx("photo")}>
                  <img
                    src="https://img.freepik.com/premium-vector/cute-avocado-cartoon-hand-drawn-style_42349-476.jpg"
                    alt="Avatar"
