...
function Dashboard() {
  ...
  const handleCustomDateRangeChange = (startDate, endDate) => {
    // Kiểm tra nếu startDate và endDate là đối tượng Date thì không cần kiểm tra định dạng
    if (
      !(startDate instanceof Date && !isNaN(startDate)) ||
      !(endDate instanceof Date && !isNaN(endDate))
    ) {
      // Validate the date format nếu không phải là đối tượng Date
      ...
      // Chuyển đổi input string thành đối tượng Date nếu là định dạng chuỗi
