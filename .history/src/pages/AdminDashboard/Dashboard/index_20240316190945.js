    ...
    datasets: [
      {
        ...
        borderWidth: 2,
        data: statistic.monthlyStatistic.map((data) => data.revenue),
      },
      {
        label: "Profit",
        fill: false,
        ...
        borderWidth: 2,
        data: statistic.monthlyStatistic.map((data) => data.profit),
      },
      {
        label: "Sold",
        fill: false,
        ...
        borderWidth: 2,
        data: statistic.monthlyStatistic.map((data) => data.sold),
      },
    ],
  };
